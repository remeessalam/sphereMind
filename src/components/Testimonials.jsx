...
const Testimonials = () => {
  ...
  return (
    <div
      id="reviews"
      className="min-h-[70vh] py-[5rem] relative w-full bg-cover bg-no-repeat bg-bottom flex items-center z-10"
    ...
    >
      ...
      <div className="wrapper grid lg:grid-cols-2 gap-10 w-full">
        ...
        >
          ...
          <h2 className="text-[2rem] text-white md:text-4xl capitalize font-semibold mb-5 text-center lg:text-start lg:max-w-[30rem]">
            Clients Feedback Examples You
          </h2>
          <p className="text-gray-100 text-sm mb-5 max-w-[30rem] text-center lg:text-start">
            At SPHEREMIND, we take pride in the success of our clients. Here's
          ...
          {testimonials.map((item) => (
            ...
            >
              ...
              <div className="sm:pl-[5rem] sm:pr-[3rem] pt-[3rem] sm:pt-0 flex flex-col gap-3">
                <p className="text-sm text-wrap">{item.feedback}</p>
