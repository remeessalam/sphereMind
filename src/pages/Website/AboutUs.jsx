  ...
  return (
    <div className="landing-bg">
        ...
        <div className="grid lg:grid-cols-2 lg:items-start gap-10">
          <div>
            ...
            <h2 className="heading capitalize mt-5">
              Empowering Growth Through Innovative Technology Solutions
            </h2>
            <p className="mt-6">
              At SPHEREMIND, we’re driven by the belief that technology has the
              potential to solve real-world problems and make a tangible
              difference. Our goal is to provide innovative digital solutions
              that not only meet your needs but also help your business grow and
              thrive in an ever-changing digital world.
              <br />
              <br />
              What started with a passion for technology and problem-solving has
              now evolved into a dedicated team of professionals committed to
              delivering exceptional results. We work with businesses of all
              sizes—from startups to established enterprises—creating custom
              solutions that are as unique as the challenges our clients face.
              <br />
              <br />
              We offer a wide range of services, including web and app
              development, AI solutions, data analytics, IoT systems, and more.
              Each project is an opportunity to push creative boundaries and
              explore new ways of delivering value. Our focus is always on
              providing results that go beyond what you expect, with solutions
              that are designed to evolve with your business.
            </p>
          </div>
      ...
      <section className="wrapper text-center">
        ...
        <p>
          Founded with the mission to drive digital transformation, SPHEREMIND
