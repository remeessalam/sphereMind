      ...
      >
        ...
        <div className="wrapper py-10 flex flex-col items-center gap-5 z-10">
          ...
          <p data-aos="fade-up" className="text-center max-w-2xl">
            At SPHEREMIND, we offer a wide range of innovative digital solutions
            aimed at helping your business stay ahead of the curve. With
            expertise in everything from custom web development to AI and IoT
            solutions, our team works closely with you to create tailored
            strategies that address your unique challenges and unlock new
            opportunities. Explore the services we offer below:
          </p>
          <div
            data-aos="fade-up"
